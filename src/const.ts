...
export const USER_IDS_KEY: string = "user-ids";
export const ROLE_IDS_KEY: string = "role-ids";

export const COLOR_SUCCESS = "#00ff99";
export const COLOR_INFO = "#ff8800";
export const COLOR_ERROR = "#ff0044";
export const COLOR_PRIMARY = "#3883be";